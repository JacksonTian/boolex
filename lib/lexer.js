...
Lexer.prototype.init = function () {
  this.keywords = [
    new TkWord(e_TokenCode.TK_PLUS,   "+"),
    new TkWord(e_TokenCode.TK_MINUS,  "-"),
    new TkWord(e_TokenCode.TK_STAR,   "*"),
    new TkWord(e_TokenCode.TK_DIVIDE, "/"),
    new TkWord(e_TokenCode.TK_MOD,    "%"),
